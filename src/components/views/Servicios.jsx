                ...
                <Row className='pb-4 d-flex justify-content-center'>
                    ...
                    <Col md="6" lg="4" className='d-flex justify-content-center'>
                        <article data-aos="fade-up" className="articleCard mx-1 my-3">
                            ...
                            <img src={iconoAlquiler} alt="icono de alquiler de kayaks" className='iconoCard' />
                    ...
                    <Col md="6" lg="4" className='d-flex justify-content-center'>
                        <article data-aos="fade-up" className="articleCard mx-1 my-3">
                            <img src={escuelita} alt="imagen de escuela de kayaks" className='imgCard' />
                            <div className="overlay"></div>
                    ...
                    <Col md="6" lg="4" className='d-flex justify-content-center'>
                        <article data-aos="fade-up" className="articleCard mx-1 my-3">
                            <img src={cumple} alt="imagen de cumpleaños infantiles" className='imgCard' />
                            <div className="overlay"></div>
                    ...
                    <Col md="6" lg="4" className='d-flex justify-content-center'>
                        <article data-aos="fade-up" className="articleCard mx-1 my-3">
                            <img src={quincho} alt="imagen de alquiler de quincho para eventos" className='imgCard' />
                            <div className="overlay"></div>
                    ...
                    <Col md="6" lg="4" className='d-flex justify-content-center'>
                        <article data-aos="fade-up" className="articleCard mx-1 my-3">
                            <img src={guarderia} alt="imagen de guardería de kayaks" className='imgCard' />
                            <div className="overlay"></div>
                            <img src={iconoGuarderia} alt="icono de guardería de kayaks" className='iconoCard p-1' />

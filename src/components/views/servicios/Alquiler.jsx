/* El código anterior es un componente de React llamado `Alquiler` que muestra información sobre el
alquiler de un quincho para eventos. Incluye imágenes del quincho, descripción del servicio de
alquiler y enlace para enviar mensaje de WhatsApp por consultas. El componente también incluye un
control deslizante de imágenes responsivo que utiliza la biblioteca `react-slick` para mostrar
múltiples imágenes del quincho. La cantidad de imágenes que se muestran en el control deslizante se
ajusta según el ancho de la ventana usando los ganchos `useState` y `useEffect`. */
                ...
                <ul className="p-0 m-0">
                  <li className="textSubtitulo">
                    <span className="textExplicacion">
                      Nuestra base operativa cuenta con un quincho cubierto y un
                      asador perfecto para organizar una amplia variedad de
                      eventos, desde cumpleaños hasta eventos deportivos. Con
                      capacidad para aproximadamente 60 personas, ofrece la
                      mejor vista del dique y sus alrededores. Además, cuenta
                      con baños, mesas y sillas para mayor comodidad.
                    </span>
                  </li>
                  <Nav.Link

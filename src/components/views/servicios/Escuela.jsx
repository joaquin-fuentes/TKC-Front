                ...
                <ul className="p-0 m-0">
                  <li className="textSubtitulo">
                    ...
                    <span className="textExplicacion">
                      La escuela de kayak ofrece clases para todas las edades y
                      niveles, cubriendo técnicas de remo, seguridad, navegación
                      y rescate. Además de enseñar habilidades básicas, promueve
                      la conexión con la naturaleza y un estilo de vida activo.
                    </span>
                  </li>
                  <li className="textSubtitulo">
                    Días de entrenamiento: <br />
                    <span className="textExplicacion">
                      Miercoles de 16 a 18hs <br /> Sábados de 11 a 13hs y de 16
                      a 18hs
                    </span>
                  </li>

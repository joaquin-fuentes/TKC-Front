                ...
                <ul className="p-0 m-0">
                  <li className="textSubtitulo">
                    <span className="textExplicacion">
                      En las orillas del Dique Celestino Gelsi, ofrecemos una
                      guardería de kayaks con capacidad para 66 embarcaciones.
                      Cada kayak tiene su propio espacio asignado donde puedes
                      almacenarlo junto con chalecos, remos y otros equipos
                      dentro del box correspondiente. Nuestras instalaciones son
                      seguras y cuentan con baños disponibles para tu comodidad.
                      Si estás cansado de transportar tu kayak en el vehículo,
                      ¡nuestra guardería es la solución perfecta!
                    </span>
                  </li>
                  <Nav.Link
                    className="text-light mt-2 fs-5 d-flex justify-content-center align-items-center"
                    target="_blank"
                    href="https://api.whatsapp.com/send?phone=3816097754&text=¡Hola! me gustaria hacer una consulta sobre la Guarderia de kayak de TKC"
                  >
                    <img
                      src={whatsapp}

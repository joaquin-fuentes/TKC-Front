                        ...
                        <Col md={6}>
                            <article data-aos="fade-up" className='p-3 text-center'>
                                ...
                                <ul className='p-0 m-0'>
                                    ...
                                    <Nav.Link className="text-light mt-2 fs-5 d-flex justify-content-center align-items-center"target='_blank' href="https://api.whatsapp.com/send?phone=3816097754&text=¡Hola! me gustaria hacer una consulta sobre COACHING EMPRESARIAL"><img src={whatsapp} className='icono-header mx-1' alt="whatsapp" />Enviar Mensaje</Nav.Link>
                                </ul>
                            </article>
                        </Col>
                    </Row>
